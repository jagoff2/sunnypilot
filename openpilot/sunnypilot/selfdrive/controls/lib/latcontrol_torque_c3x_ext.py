...
class LatControlTorqueExt(NeuralNetworkLateralControl, LatControlTorqueExtOverride):
  ...
  def calculate(self, CS, VM, params, setpoint, measurement, calibrated_pose, roll_compensation,
                desired_lateral_accel, actual_lateral_accel, lateral_accel_deadzone, desired_curvature, actual_curvature):
    ...
    return self.calculate_neural_network(CS, params, calibrated_pose)
