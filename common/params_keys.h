...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DiffusionDriveEndpoint", {PERSISTENT | BACKUP, STRING}},
    {"DiffusionDriveStatus", {CLEAR_ON_MANAGER_START, STRING}},
    {"EnableDiffusionDrive", {PERSISTENT | BACKUP | DEVELOPMENT_ONLY, BOOL, "0"}},
